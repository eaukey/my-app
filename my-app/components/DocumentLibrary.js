      ...
      >
        ...
        <div className="py-4">
          <svg viewBox="0 0 100 120" className="w-12">
            <path d="M50 5 L95 60 L95 90 L50 115 L5 90 L5 60 Z" fill="white" stroke="none" />
            <path d="M25 80 L75 80 M20 85 L80 85" stroke="white" strokeWidth="2" fill="none" />
            <text x="50" y="70" textAnchor="middle" fill="#41AEAD" style={{ fontSize: '16px', fontFamily: 'Arial, sans-serif' }}>
              Eaukey
            </text>
          </svg>
        </div>
